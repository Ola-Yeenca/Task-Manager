...
class TaskManager:
    ...
    def create_widgets(self):
        ...
        task_name_label = ttk.Label(self.root, text="Task Name:").grid(row=0, column=0, sticky='w')
        ...
        # Create button
        add_task_button = ttk.Button(self.root, text="Add Task", command=self.add_task).grid(row=3, column=0, padx=10, pady=5)
